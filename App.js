...
import Contacts from './src/views/drawer/Contacts';
import Favorites from './src/views/drawer/Favorites';
import Settings from './src/views/drawer/Settings';

import Tab1 from './src/views/tabs/Tab1';
import Tab2 from './src/views/tabs/Tab2';
import Tab3 from './src/views/tabs/Tab3';
