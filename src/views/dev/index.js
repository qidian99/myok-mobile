      ...
      <Button
        onPress={() => {
          PushNotification.localNotification({
            ...
            channelId: 'document', // (required) channelId, if the channel doesn't exist, it will be created with options passed above (importance, vibration, sound). Once the channel is created, the channel will not be update. Make sure your channelId is different if you change these options. If you have created a custom channel, it will apply options of the channel.
            ...
            subText: 'Your have a new document to sign', // (optional) default: none
            ...
            message: 'Your have a new document to sign.', // (required)
